...
const VALID_MATERIAL: StandardMaterial3D = preload("res://resources/materials/constructable_invalid_material.tres")
const INVALID_MATERIAL: StandardMaterial3D = preload("res://resources/materials/constructable_valid_material.tres")
...
func set_preview_material(material: StandardMaterial3D) -> void:
	# GETING MATERIAL COUNT constructable_preview_mesh.get_surface_count():
